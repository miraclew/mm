...
Log::write("alipay_notify", 'donate_notify');
Log::write("notify data: $details", 'donate_notify');
...
$data = array('verifyresult' => $verify_result,'tradestatus' => $trade_status, 'orderno' => $out_trade_no, 'outtradeno' => $trade_no, 'tradedetails'=> $details);
