...
require (MAIN_."lib/tenpay_web/classes/ResponseHandler.class.php");
require (MAIN_."lib/tenpay_web/classes/RequestHandler.class.php");
require (MAIN_."lib/tenpay_web/classes/client/ClientResponseHandler.class.php");
require (MAIN_."lib/tenpay_web/classes/client/TenpayHttpClient.class.php");
require (MAIN_."lib/tenpay_web/classes/function.php");
...
// 				log_result("即时到帐验签ID成功");
	...
	//如果有使用折扣券，discount有值，total_fee+discount=原请求的total_fee
				...
				$data = array('verifyresult' => true,'tradestatus' => $trade_state, 'orderno' => $out_trade_no, 'outtradeno' => $transaction_id, 'tradedetails'=> $details,'totalfee'=>$total_fee);
